/**
 * Staff Login Page
 * For managers, kitchen staff, waiters, and other staff
 */
import React, { useState } from 'react';
import { Link } from 'react-router-dom';
import { useAuthAPI } from '../../hooks/useAuthAPI';
import { useTheme } from '../../contexts/ThemeContext';
import { Users, Eye, EyeOff, Loader } from 'lucide-react';

const StaffLogin: React.FC = () => {
  const { staffLogin, isLoading } = useAuthAPI();
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className={`mt-2 text-center text-sm ${
            ...
            For managers, kitchen staff, waiters & team members
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className={`mt-6 p-4 rounded-md ${
            ...
            <div className={`text-xs mt-1 space-y-1 ${
              ...
              <p>Kitchen: kitchen@test.com / kitchen123</p>
