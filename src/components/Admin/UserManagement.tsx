  ...
  const users: User[] = [
    {
      ...
      loginCount: 1247,
      lastActivity: 'Reviewed vendor applications'
    },
    {
      id: '2',
      name: 'Sarah Johnson',
      ...
      loginCount: 856,
      lastActivity: 'Updated menu prices'
    },
    {
      id: '3',
      name: 'Mike Chen',
      ...
      department: 'Kitchen',
      loginCount: 423,
      lastActivity: 'Completed 12 orders'
    },
    {
      id: '4',
      name: 'Emma Wilson',
    ...
    },
    {
      ...
      department: 'External',
      loginCount: 234,
      lastActivity: 'Updated delivery settings'
    }
  ];
